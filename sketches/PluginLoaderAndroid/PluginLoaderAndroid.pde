...
class Plugin {
  ...
  public boolean compile(String code) {
    ...
    final String javaFileOut = "pluginCache/CustomPlugin.java";
    final String classFileOut = "pluginCache/CustomPlugin.class";
...
void setup() {
  ...
  String[] txts = loadStrings("plugin_boilerplate.java");
  for (String s : txts) {
...
CmdOutput toClassFile(String inputFile) {
  ...
  final String pluginPath = "pluginCache/";
...
String toJarFile(String classFile) {
  ...
  final String out = "pluginCache/cache-"+cacheEntry+".jar";
