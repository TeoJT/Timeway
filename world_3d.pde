...
public class PixelRealm extends Screen {
  ...
  public final Runnable generateQuickWarp = new Runnable() {
    public void run() {
      ...
      sharedResources.set(QUICK_WARP_DATASET, quickWarp);
    }
  };
  ...
  public void setup(String dir, String emergeFrom) {
    ...
    img_grass = display.systemImages.get("grass");
    img_neonTest = display.systemImages.get("neonTest");
    img_coin[0]  = display.systemImages.get("coin_0");
    img_coin[1]  = display.systemImages.get("coin_1");
    img_coin[2]  = display.systemImages.get("coin_2");
    img_coin[3]  = display.systemImages.get("coin_3");
    img_coin[4]  = display.systemImages.get("coin_4");
  ...
  private void runPixelRealm() {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      if (engine.keyActionOnce("quickWarp"+str(i))) {
        ...
        QuickWarpSaveInfo[] quickWarp = (QuickWarpSaveInfo[])sharedResources.get(QUICK_WARP_DATASET, generateQuickWarp);
        ...
        // Now go to new warp
        endRealm();
        sharedResources.set(QUICK_WARP_ID, new Integer(i));
        portalLight = 255.;
